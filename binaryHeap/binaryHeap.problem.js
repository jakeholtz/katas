...
BinaryHeap.prototype.swap = function (index, parentIndex) {
...
BinaryHeap.prototype.insert = function (value) {
  ...
  while (index && this._compare(this._heap[index], this._heap[parentIndex])) {
...
BinaryHeap.prototype.findSmallestChildIndex = function (parentIndex) {
  if (this._heap[parentIndex * 2 + 1] > this._heap[parentIndex * 2 + 2]) {
...
BinaryHeap.prototype.removeRoot = function () {
  var oldRoot = this._heap[0];
  this._heap[0] = this._heap[this._heap.length - 1];
  this._heap.pop();
  var parentIndex = 0;
  var index = this.findSmallestChildIndex(parentIndex);
  while (index && this._compare(this._heap[index], this._heap[parentIndex])) {
      this.swap(index, parentIndex);
      parentIndex = index;
      index = this.findSmallestChildIndex(parentIndex);
  }
  return oldRoot;
}
