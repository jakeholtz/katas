...
LRUCache.prototype.get = function (key) {
  ...
  this.ordering.moveToFront(this.contents[key].list);
  return this.contents[key].val;
};
...
LRUCache.prototype.set = function (key, val) {
  ...
  if (this.contents[key]) {
    ...
    if (this.length === this.limit) {
      var deleted = this.ordering.pop();
      delete this.contents[deleted.key];
      this.length--;
    }
    this.contents[key] = item;
    item.list = this.ordering.unshift(item);
    this.length++;
  }
};
